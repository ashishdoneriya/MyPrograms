...
public:
	...
	//It returns the string in the format like ashish doneriya becomes Ashish Doneriya
	char * Upper_Lower(const char *str);
	
	//It accepts a string and returns the double dimensiona array of string
	...
	//It returns 1 if the given string is a number else 0
	int check_number(char *str);

	//It accepts the string as argument, covert it into the number and returns the no. ex. phone no.
	long get_phone(const char *);
	int strcomp(const char *str1, const char *str2);
	//It accepts the string as arguent & check whether the string as phone number is correct or not
	int valid_num(const char *string);
